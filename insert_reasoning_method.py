#!/usr/bin/env python3
"""Insert reasoning method into ollama_service.py"""

# Read the reasoning method from our temp file
reasoning_method = '''
...
with open('/Users/sauravchakraborty/DbChat/app/services/ollama_service.py', 'r') as f:
    lines = f.readlines()

# Find the insertion point (after generate_sql method, before identify_tables)
insertion_point = None
for i, line in enumerate(lines):
    if 'async def identify_tables' in line:
        insertion_point = i
        break
...
# Insert the reasoning method
new_lines = lines[:insertion_point] + [reasoning_method + '\n'] + lines[insertion_point:]

# Write back
with open('/Users/sauravchakraborty/DbChat/app/services/ollama_service.py', 'w') as f:
    f.writelines(new_lines)

print(f"✓ Successfully inserted reasoning method at line {insertion_point}")
